...
const VideoContainer = ({ movieId, title, view }) => {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="absolute inset-y-0 left-0 flex flex-col items-start justify-center p-4 sm:p-6 md:p-8 lg:p-10 max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg ml-4 md:ml-8 lg:ml-12 bg-gradient-to-r from-black/80 to-transparent">
